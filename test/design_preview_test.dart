...
void main() {
  ...
  for (final device in [('mobile', const Size(390, 844)), ('desktop', const Size(1440, 900))]) {
    testWidgets('Export ${device.$1} design previews', skip: !capture, (tester) async {
      ...
      await tester.runAsync(() async {
        for (final name in ['s1_1','s1_2','s1_3','s1_4','s1_5','s1_6','s1_7','s2_0','s2_1','s2_2','s2_3','s2_4','s2_5','s2_6','s2_7','s2_8','s2_13','s2_14','s2_15','s3_1','s3_2','s3_3','s3_4','s4_0']) {
      ...
      for (var tab = 0; tab < 4; tab++) {
        ...
        await expectLater(find.byType(MainScreen), matchesGoldenFile('previews/${device.$1}-$tab.png'));
      }
      ...
      await expectLater(find.byType(MaterialApp), matchesGoldenFile('previews/${device.$1}-game.png'));
